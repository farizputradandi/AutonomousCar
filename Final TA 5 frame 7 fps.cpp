...
void Perspective()
{
	...
	//line(frame,Source[1], Source[2], Scalar(0,0,255), 1);
	//line(frame,Source[2], Source[3], Scalar(0,0,255), 1);
	//line(frame,Source[3], Source[0], Scalar(0,0,255), 1); 
	
	//line(frame,Destination[0], Destination[1], Scalar(0,255,0), 2);
	//line(frame,Destination[1], Destination[2], Scalar(0,255,0), 2);
	//line(frame,Destination[2], Destination[3], Scalar(0,255,0), 2);
	//line(frame,Destination[3], Destination[0], Scalar(0,255,0), 2);
...
void Threshold()
{
	...
	Canny(frameThresh,frameEdge, 500, 900, 3, false);
...
void Histrogram()
{
    ...
    //Rect r = Rect(80,140,300,100);
    //rectangle(frameFinal, r, Scalar(0,0,255), 2);

    //line(frameFinal, Point2f(90, 0), Point2f(90, 240), Scalar(0, 0,255), 2);    
...
{ 
	...
	//if(!Stop_Cascade.load("//home//pi//Desktop//c++//cascade_file//traffic_cascade9.xml"))
	//if(!Stop_Cascade.load("//home//pi//Desktop//c++//cascade_file//cascade3.xml")) 
	if(!Stop_Cascade.load("//home//pi//Desktop//c++//cascade_file//stop90.xml")) 
			       //home//pi//Desktop//c++//cascade_file//90.xml
	{
